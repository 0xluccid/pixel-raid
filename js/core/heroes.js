...
const CARD_TEMPLATES = [
    ...
    { name: 'Iron Knight',      cls: 'warrior',
      image: 'assets/characters/iron_knight.png',  hp: 120, atk: 18, def: 22, spd: 8,  crit: 5,
      lore: 'Once a lowly blacksmith, he forged his own armor from a fallen meteorite. Now he stands as the unbreakable wall between darkness and the realm.',
      skill: { name: 'Shield Wall', type: 'buff_def', val: 0.3, chance: 0.3 } },
    { name: 'Berserker',        cls: 'warrior',
      image: 'assets/characters/berserker.png',  hp: 100, atk: 28, def: 12, spd: 10, crit: 15,
      lore: 'Banished from the Northern Wastes for his uncontrollable rage, the Berserker channels fury into devastating strikes that shatter even enchanted armor.',
      skill: { name: 'Rage', type: 'buff_atk', val: 0.5, chance: 0.25 } },
    { name: 'Paladin',          cls: 'warrior',
      image: 'assets/characters/paladin.png',  hp: 140, atk: 14, def: 25, spd: 6,  crit: 5,
      lore: 'Sworn to an ancient oath of protection, the Paladin\'s holy light shields allies from the darkest spells. His faith is his strongest armor.',
      skill: { name: 'Holy Guard', type: 'shield', val: 30, chance: 0.3 } },
    { name: 'Dark Knight',      cls: 'warrior',
      image: 'assets/characters/dark_knight.png',  hp: 110, atk: 24, def: 18, spd: 9,  crit: 10,
    ...
    { name: 'Fire Mage',        cls: 'mage',
      image: 'assets/characters/fire_mage.png',     hp: 70,  atk: 32, def: 8,  spd: 12, crit: 10,
      lore: 'Raised in the volcanic academy of Ignis Peak, she commands flames that can melt steel. Her Fireball spell has turned the tide of countless battles.',
      skill: { name: 'Fireball', type: 'aoe', val: 0.6, chance: 0.3 } },
    { name: 'Ice Witch',        cls: 'mage',
      image: 'assets/characters/ice_witch.png',     hp: 75,  atk: 28, def: 10, spd: 11, crit: 8,
      ...
      skill: { name: 'Frost Nova', type: 'debuff_spd', val: 0.3, chance: 0.3 } },
    { name: 'Lightning Lord',   cls: 'mage',
      image: 'assets/characters/lightning_lord.png',     hp: 65,  atk: 35, def: 7,  spd: 14, crit: 12,
      lore: 'He rides storm clouds and calls down chain lightning that jumps between foes. The crackling energy around him never fully fades.',
      skill: { name: 'Chain Lightning', type: 'aoe', val: 0.8, chance: 0.2 } },
    { name: 'Void Sorcerer',    cls: 'mage',
      image: 'assets/characters/void_sorcerer.png',     hp: 80,  atk: 30, def: 9,  spd: 10, crit: 15,
      lore: 'Peering into the space between dimensions, she tears rifts that deal damage no armor can block. The void whispers secrets only she can hear.',
      skill: { name: 'Void Rift', type: 'true_dmg', val: 20, chance: 0.25 } },
    
    // Archers
    { name: 'Wind Ranger',      cls: 'archer',
      image: 'assets/characters/wind_ranger.png',   hp: 80,  atk: 24, def: 10, spd: 18, crit: 12,
      lore: 'Swift as the mountain breeze, she fires multiple arrows before the first one lands. Her accuracy is legendary across the frontier.',
      skill: { name: 'Multi Shot', type: 'multi_hit', val: 2, chance: 0.25 } },
    { name: 'Shadow Sniper',    cls: 'archer',
      image: 'assets/characters/shadow_sniper.png',   hp: 70,  atk: 30, def: 8,  spd: 16, crit: 20,
      lore: 'A phantom assassin who strikes from impossible distances. One clean headshot is all she needs — her enemies never see the arrow coming.',
      skill: { name: 'Headshot', type: 'crit_boost', val: 2.0, chance: 0.2 } },
    { name: 'Beast Tamer',      cls: 'archer',
      image: 'assets/characters/beast_tamer.png',   hp: 90,  atk: 22, def: 12, spd: 14, crit: 10,
      lore: 'Bonded with a sacred eagle since childhood, their combined strikes bypass even the toughest hide. The beast sees what eyes cannot.',
      skill: { name: 'Eagle Strike', type: 'ignore_def', val: 0.5, chance: 0.25 } },
    { name: 'Storm Archer',     cls: 'archer',
      image: 'assets/characters/storm_archer.png',   hp: 75,  atk: 26, def: 9,  spd: 20, crit: 14,
      lore: 'Each arrow carries a tiny thunderbolt. When they strike, enemies are stunned by the electric shock, frozen mid-step in battle.',
      skill: { name: 'Thunder Arrow', type: 'stun', val: 1, chance: 0.2 } },
    
    // Healers
    { name: 'Holy Priest',      cls: 'healer',
      image: 'assets/characters/holy_priest.png',   hp: 90,  atk: 10, def: 14, spd: 10, crit: 5,
      lore: 'Devoted to the Temple of Dawn, her prayers mend wounds and restore hope. Even in the darkest battle, her light keeps allies standing.',
      skill: { name: 'Heal', type: 'heal', val: 0.25, chance: 0.4 } },
    { name: 'Druid',            cls: 'healer',
      image: 'assets/characters/druid.png',   hp: 100, atk: 14, def: 16, spd: 8,  crit: 5,
      lore: 'Guardian of the ancient forest, she channels nature\'s regrowth to slowly mend wounds over time. The forest itself fights alongside her.',
      skill: { name: 'Regrowth', type: 'hot', val: 0.1, chance: 0.35 } },
    { name: 'Battle Medic',     cls: 'healer',
      image: 'assets/characters/battle_medic.png',   hp: 85,  atk: 16, def: 12, spd: 12, crit: 8,
      lore: 'A frontline healer who patches wounds mid-combat. She fights and heals in equal measure — no one dies on her watch.',
      skill: { name: 'Combat Heal', type: 'heal', val: 0.20, chance: 0.35 } },
    { name: 'Necromancer',      cls: 'healer',
      image: 'assets/characters/necromancer.png',   hp: 80,  atk: 18, def: 10, spd: 11, crit: 10,
      lore: 'She walks the line between life and death, draining enemy vitality to sustain her allies. Her dark arts are feared — and respected.',
      skill: { name: 'Life Drain', type: 'lifesteal', val: 0.25, chance: 0.3 } },
    
    // Assassins
    { name: 'Phantom Blade',    cls: 'assassin',
      image: 'assets/characters/phantom_blade.png', hp: 65,  atk: 34, def: 6,  spd: 22, crit: 25,
      lore: 'Appearing from thin air, his twin blades strike vital points with lethal precision. By the time you see him, it\'s already too late.',
      skill: { name: 'Backstab', type: 'crit_boost', val: 2.5, chance: 0.25 } },
    { name: 'Venom Dancer',     cls: 'assassin',
      image: 'assets/characters/venom_dancer.png', hp: 70,  atk: 28, def: 8,  spd: 20, crit: 18,
      lore: 'Her graceful movements hide deadly intent. Every blade is coated in paralyzing venom — one cut is all it takes to doom her prey.',
      skill: { name: 'Poison Blade', type: 'dot', val: 10, chance: 0.3 } },
    { name: 'Shadow Monk',      cls: 'assassin',
      image: 'assets/characters/shadow_monk.png', hp: 75,  atk: 26, def: 10, spd: 19, crit: 20,
      lore: 'Trained in forbidden shadow arts, he phases through attacks like smoke. His elusive style makes him nearly impossible to pin down.',
      skill: { name: 'Shadow Step', type: 'dodge_buff', val: 0.3, chance: 0.25 } },
    { name: 'Reaper',           cls: 'assassin',
      image: 'assets/characters/reaper.png', hp: 60,  atk: 38, def: 5,  spd: 24, crit: 30,
      lore: 'The final sight many enemies see. His scythe executes wounded foes instantly — those below 30% health have no chance of survival.',
      skill: { name: 'Execute', type: 'execute', val: 0.3, chance: 0.15 } },
];
